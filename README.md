...
Vue is a progressive front-end JavaScript framework, built for performance and
versatility.
...
This is a simple tutorial for building with Deno and Vue, using a separate
backend and frontend.

There are many things you can add, such as:

- persistent data with [GraphQL](), [Apollo](), [Mongoose](), [Prisma](), and
  [more]().
- deploy this to various virtual private servers, such as ...
- adding authentication and billing to become a full fledged web app
